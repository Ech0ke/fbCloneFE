...
import { AiOutlineShop, AiFillBell } from "react-icons/ai";
  ...
  return (
    <div className="bg-white flex items-center p-2 shadow-md top-0 sticky z-50 h-16">
      ...
      <div className="flex items-center justify-end min-w-fit space-x-2">
        <ProfilePicture useSignOut={true} />
        <p className="hidden xl:inline-flex font-semibold text-sm whitespace-nowrap">
        ...
        />
        <FaFacebookMessenger className="hidden lg:inline-flex h-10 w-10 bg-gray-200 text-gray-600 rounded-full p-2 cursor-pointer hover:bg-gray-300" />
        <AiFillBell
          size={20}
          className="hidden lg:inline-flex h-10 w-10 bg-gray-200 text-gray-600 rounded-full p-2 cursor-pointer hover:bg-gray-300"
        />
